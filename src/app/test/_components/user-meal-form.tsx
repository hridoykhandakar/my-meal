...
import { User, MealEntry } from "../types/user";

export default function UserMealForm() {
            ...
            >
              <div className="space-y-4">
                <div>
                  ...
                  <div className="p-2">{field.name}</div>
                  <input type="hidden" {...register(`entries.${index}.name`)} />
                  <Input
                    type="date"
                    disabled={true}
