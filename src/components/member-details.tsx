...
const memberData = {
  "1": {
    ...
    expenses: [
      ...
      { date: "2023-06-08", items: "Meat, Dairy", amount: 78.90 },
  ...
  "2": {
    ...
    expenses: [
      { date: "2023-06-03", items: "Fruits, Dairy", amount: 55.20 },
      { date: "2023-06-10", items: "Vegetables, Snacks", amount: 42.30 },
  ...
  "3": {
    ...
    expenses: [
      { date: "2023-06-05", items: "Vegetables, Meat", amount: 72.40 },
      { date: "2023-06-12", items: "Fruits, Dairy", amount: 48.90 },
      { date: "2023-06-19", items: "Snacks, Grains", amount: 35.60 },
    ],
    balance: -5.30,
  },
  "4": {
    ...
    expenses: [
      { date: "2023-06-02", items: "Dairy, Snacks", amount: 38.50 },
      { date: "2023-06-09", items: "Vegetables, Fruits", amount: 62.70 },
      { date: "2023-06-16", items: "Meat, Grains", amount: 85.30 },
    ],
    balance: 10.20,
  },
  "5": {
    ...
    expenses: [
      { date: "2023-06-04", items: "Fruits, Vegetables", amount: 58.90 },
      { date: "2023-06-11", items: "Meat, Dairy", amount: 76.40 },
      { date: "2023-06-18", items: "Grains, Snacks", amount: 41.20 },
    ],
    balance: -8.70,
  },
}
...
export function MemberDetails() {
  ...
  const summary = useMemo(() => {
    ...
    const totalMeals = data.mealConsumption.reduce((sum, week) => sum + week.day + week.night, 0)
    const totalMarketExpenses = data.expenses.reduce((sum, expense) => sum + expense.amount, 0)
    ...
    return (
      <Card className="col-span-3">
        <CardHeader>
          ...
          <CardDescription>View detailed information for each member</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <Card className="col-span-3">
      ...
      <CardContent>
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total Market Expenses</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">${summary.totalMarketExpenses.toFixed(2)}</div>
            </CardContent>
          </Card>
        </div>
